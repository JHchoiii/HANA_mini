  ...
  return (
    <div className="MyIns overflow-auto bg-[#f2f6f5]">
      ...
      <div className="mt-10 bg-[#E0FFE3] rounded-[20px] flex flex-col justify-center">
        ...
        <img
          // src="https://www.hanacapital.co.kr/assets/img-medical-loan.png"
          src="https://day.hanainsure.co.kr/static/resources/platform/oneday/images/main/panel_icon_overseas.jpg"
          alt="여행"
      ...
      <div className="flex justify-around items-start mx-10 my-20">
        <div className="flex flex-col items-center text-center w-[300px] relative">
          <img
            src="https://day.hanainsure.co.kr/static/resources/platform/oneday/images/insurance_intro/sub-one-year-1.svg"
            alt="아이콘 1"
            className="w-25 h-25 mb-4 animate__animated animate__fadeInLeft animate__delay-0.7s"
          />
          <img
            src="https://day.hanainsure.co.kr/static/resources/platform/oneday/images/insurance_intro/sub-one-year-2.svg"
            alt="아이콘 1"
            className="absolute bottom-[100px] right-[100px] w-25 h-25 mb-4 animate__animated animate__fadeIn animate__delay-0.9s"
          />
        ...
        <div className="flex flex-col justify-center items-center text-center w-[300px] relative">
          <img
            src="https://day.hanainsure.co.kr/static/resources/platform/oneday/images/insurance_intro/sub-card-payment-1.svg"
            alt="아이콘 1"
            className="w-25 h-25 mb-2 mt-2 animate__animated animate__fadeIn animate__delay-0.7s"
          />
          <svg
            ...
            className="absolute bottom-[160px] right-[165px]"
          >
            <path
              class="animated-path"
          ...
          <h2 className="text-lg font-bold h-[30px] mt-3 mb-2">
            부담없는 <br />
            보험료
          </h2>
        ...
        <div className="flex flex-col items-center text-center w-[300px]">
          <img
            src="/Grade.png"
            alt="아이콘 3"
            className="w-[90px] h-[90px] mb-2 animate__animated animate__fadeInRight animate__delay-1.4s"
          />
      ...
      <div
        ref={ref}
        className="bg-gradient-to-b from-teal-300 to-teal-500 p-10 text-white text-center w-[800px] h-[450px] rounded-[20px]"
      >
      ...
      >
        ...
        <span className="relative bg-gray-600 text-white text-xs font-semibold px-2 py-1 rounded transition-colors duration-200 group-hover:bg-[#54d2c4]">
          PDF
        </span>
      </div>
      ...
      <Link to="/InsGift/giveGift/Step0101">
        <button className="w-[250px] h-[55px] m-[50px] bg-[#54d2c4] hover:bg-black rounded-[30px] text-white font-bold py-2 px-4 shadow-md transition duration-300">
          가입하기
        </button>
      </Link>
      <Footer />
...
export default DomesticTravelProd;
